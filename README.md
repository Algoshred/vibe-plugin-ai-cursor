...
```bash
vibe plugin install @vibecontrols/vibe-plugin-ai-cursor
```

Or install the npm package directly into an existing project that hosts the VibeControls agent:

```bash
bun add @vibecontrols/vibe-plugin-ai-cursor
# or
npm install @vibecontrols/vibe-plugin-ai-cursor
```
...
- npm: <https://www.npmjs.com/package/@vibecontrols/vibe-plugin-ai-cursor>
- Source: <https://github.com/algoshred/vibe-plugin-ai-cursor>
- Plugin contract / SDK: <https://github.com/algoshred/vibecontrols-plugin-sdk>
- Plugin catalogue: <https://vibecontrols.com/plugins/ai-cursor>
